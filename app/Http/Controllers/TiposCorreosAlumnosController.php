...
class TiposCorreosAlumnosController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $registros = DB::table('tipos_correos_alumnos')
        ...
        $tipos_correos = [
            ...
            "confTabla"=>array(
                ...
                "routeDestroy" => 'tipos_correos.destroy',
                "routeCreate" => ['formulario','alta_escuelas'],
                "routeEdit" => 'tipos_correos.edit', // referente a un método ListadoFormularios
                "routeShow" => 'tipos_correos.show',
                "routeIndex" => 'tipos_correos.index',
                "searchFor"=>$searchFor,
        ...
        return view('sistema_cobros.tipos_correos.index', $tipos_correos);
    }
    ...
    {
        return view('sistema_cobros.tipos_correos.create',[
    ...
    {
        $alumno = TipoCorreo::findOrFail($id);
        $alumno->update([
