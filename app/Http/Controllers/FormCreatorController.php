...
class FormCreatorController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      $registros = DB::table('form_creator')
        ->select('form_creator.id','form_creator.titulo',
        'form_creator.activo','form_creator.nombre_documento','form_creator.action',
    ...
    public function store(Request $request)
    {
       ...
       if ($request->hasFile('banner_formulario')) {
        ...
        $resultados = [
            ...
            "hidden_identifier"=>$form->hidden_identifier,
