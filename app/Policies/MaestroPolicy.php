...
class MaestroPolicy
{
    ...
    {
        // Only if the user_type is [developer,admin]
        return true;
    }
     ...
     */
    public function restore(User $user, Maestro $maestro): bool
    {
        //
    }
     ...
     */
    public function forceDelete(User $user, Maestro $maestro): bool
    {
        //
    }
}
