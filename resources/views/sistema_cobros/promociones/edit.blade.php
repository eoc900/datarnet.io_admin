    ...
    <form action="{{ route('promociones.update', $promocion->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            @if ($promocion->banner_1200x700)
                <img src="{{ asset('storage/banners_promociones/' . $promocion->banner_1200x700) }}" alt="Banner 1200x700" class="img-fluid mt-2" width="200">
            @endif
        </div>
        ...
        <div class="mb-3">
            ...
            @if ($promocion->banner_300x250)
                <img src="{{ asset('storage/banners_promociones/' . $promocion->banner_300x250) }}" alt="Banner 300x250" class="img-fluid mt-2" width="200">
            @endif
        </div>
