...
<div class="card-header pt-3">
    <h5>Crear un nuevo tipo de correo para maestro</h5>
</div>
<div class="card-body">
    <form class="row" method="post" action="{{ route('tipos_correos_maestros.update',$obj->id) }}" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <x-lista-mensajes/>
        <div class="row">
