@extends('sistema_cobros.pagos.layouts.create_layout')
@section('content')
...
<x-form-in-card :titulo="$titulo_formulario" :route="$routeStore">
        ...
        <div class="row">
            ...
            <div class="col-6 pt-3">
                <x-dropdown-formulario label="Tipo de pago" id="activo" :options="$opciones" value-key="id" option-key="option" simpleArray="true" name="tipo_pago" />
            </div>
