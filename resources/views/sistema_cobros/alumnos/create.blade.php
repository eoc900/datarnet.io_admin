...
<div class="card-header pt-3">
    <h5>Crear un nuevo alumno</h5>
</div>
<div class="card-body">
    <form class="row" method="post" action="{{ route('alumnos.store') }}" enctype="multipart/form-data">
        @csrf
        <x-lista-mensajes/>
        <div class="row">
            <div class="col-12">
            ...
            <div class="col-12">
                <input type="hidden" class="form-control" id="prueba" name="prueba" placeholder="Ejemplo: Ulises" value ="false" required>
            </div>

            {{-- Correos del contacto múltiples inputs --}}
            <hr>
            <h5>Enlazar correos del alumno.</h5>
            <div class="contenedor_inputs ps-5 pb-5">
                    <label class="mt-4">Correo del alumno</label>
            ...
            {{-- Correos del contacto múltiples inputs --}}
            <hr>
            <h5>Enlazar teléfonos del alumno</h5>
            <div class="contenedor_inputs_3 ps-5 pb-5">
                 <label class="mt-4">Telefono del alumno</label>
            ...
            <hr>
            <h5>Enlazar direcciones del alumno</h5>
