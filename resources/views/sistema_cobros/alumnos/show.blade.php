...
@section("content")
    ...
    <div class="card">
      <div class="card-body">
          @include("sistema_cobros.alumnos.secciones.recibiste_correo_bienvenida",["ccuenta"=>$ccuenta])
        
          @include("sistema_cobros.alumnos.modals.re_escribir_correo",["alumno_id"=>$alumno->id_alumno,"ccuenta"=>$ccuenta->ccuenta])
      </div>
    </div>
                ...
                <div class="d-flex align-items-start justify-content-between mb-3">
                 ...
                 <div class="full-info">
                  <div class="info-list d-flex flex-column gap-3">
                    ...
                    <div class="info-list-item d-flex align-items-center gap-3"><span class="material-icons-outlined">send</span><p class="mb-0">Email: </p></div>
                    <div class="info-list-item d-flex align-items-center gap-3"><span class="material-icons-outlined">call</span><p class="mb-0">Phone:  </p></div>
                  </div>
                </div>
              </div>
            </div>
