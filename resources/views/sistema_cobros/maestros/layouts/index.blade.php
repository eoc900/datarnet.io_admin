     ...
     <script>
        $(document).ready(function(){
            ...
            function renderMultipleInputs(tipoInputs){
                ...
                $.ajax({
                    url: '{{ url("/add_multiple/correos_maestros") }}',
                    method: "post",
            ...
            function remove_inputs_event(){
                ...
                $('.remove_inputs').click(function(){
                    ...
                    var conteo = $(this).closest(".holder");
                   conteo = conteo.find(".remove_inputs").length;
            ...
            id: item.id,
             ...
             <x-snippet-on-change idChange="buscarMaestro">
                        ...
                        window.location.href = "/maestros_materias/definir_materias/" + id;
            </x-snippet-on-change>
