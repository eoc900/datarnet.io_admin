@extends('sistema_cobros.commons.layouts.index')
@section("content")
                ...
                <div class="col-lg-12">
                    <div class="text-center error-pages">
                        ...
                        <div class="mt-4 d-flex align-items-center justify-content-center gap-3">
                          <a href="{{ url('/login') }}" class="btn btn-grd-danger rounded-5 px-4"><i class="bi bi-house-fill me-2"></i>Inicio</a>
                    
   
                          <a href="{{ url()->previous() !== url()->current() ? url()->previous() : route('login') }}" class="btn btn-light rounded-5 px-4"><i class="bi bi-arrow-left me-2"></i>Regresar a página anterior</a>
                        </div>
