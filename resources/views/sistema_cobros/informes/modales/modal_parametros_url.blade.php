          ...
          <div class="card mb-3 p-3 shadow-sm parametro-url-bloque" data-index="__INDEX__" id="parametro-__INDEX__">
            <div class="row">
              <div class="col-md-4">
                ...
                <input type="text" class="form-control" name="parametros[__INDEX__][nombre]">
              </div>
              <div class="col-md-4">
                <label>Tipo de dato</label>
                <select class="form-control" name="parametros[__INDEX__][tipo]">
              ...
              <div class="col-md-3">
                ...
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="parametros[__INDEX__][requerido]">
...
<script>
    ...
    if (param.nombre) bloque.querySelector(`[name="parametros[${index}][nombre]"]`).value = param.nombre;
    if (param.tipo) bloque.querySelector(`[name="parametros[${index}][tipo]"]`).value = param.tipo;
    if (param.requerido) bloque.querySelector(`[name="parametros[${index}][requerido]"]`).checked = true;
