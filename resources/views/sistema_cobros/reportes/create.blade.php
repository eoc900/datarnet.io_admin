@extends('sistema_cobros.reportes.layouts.index')
@section("content")
...
<div class="card-header pt-3">
    <h5>Crear un reporte</h5>
</div>
<div class="card-body">
    <form class="row" method="post" action="{{ route('reportes.store') }}" enctype="multipart/form-data">
        @csrf
        <x-lista-mensajes/>
        ...
        <div class="row">
            <x-campo-formulario label="Nombre del Reporte" id="nombre_reporte" name="nombre_reporte" type="text" placeholder="Reporte semanal 20250101" required="true"  parentClass="col-12"/>
            <div class="col-md-12">
