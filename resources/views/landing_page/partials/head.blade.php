...
<link rel="shortcut icon" type="image/x-icon" href="{{ asset("centro_estudios/assets/img/logo/favicon.png");}}">
<meta property="og:image" content="{{ asset("centro_estudios/assets/img/social/banner/centro-de-estudios-inscripciones-abiertas.jpg");}}"/>
